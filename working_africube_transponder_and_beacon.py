    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/pi/africube_software/test_audio.wav', True)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -24000, Beacom_mixer_gain, 0, 0)
...
def main(top_block_cls=test_rpitx, options=None):
    tb = top_block_cls()
